 ...
 * @author kharc
 */
public class FinalizeRoomWorkArea extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private FinalizeRoomOrg organization;
    private Enterprise enterprise;
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public FinalizeRoomWorkArea(JPanel userProcessContainer, UserAccount account, FinalizeRoomOrg organization, EcoSystem business, Enterprise enterprise) {
        initComponents();
...
//        valueLabel.setText(enterprise.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FINALIZE AcCCOMODATION");

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jLabel2.setText("List of Request received from Scheme Provison");

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jLabel3.setText("List of Request sent by you to Accomodation Agreement");
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
       ...
       FinalizeHouseWorkRequest request1 = (FinalizeHouseWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        FinalizeHouseWorkRequest request = (FinalizeHouseWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
        if(request.getReceiver()==userAccount){
            ...
            FinalizeRoomWorkRequest processWorkRequestJPanel = new FinalizeRoomWorkRequest(userProcessContainer, request,userAccount, business);
            userProcessContainer.add("FinalizeHousingWorkRequestJPanel", processWorkRequestJPanel);
